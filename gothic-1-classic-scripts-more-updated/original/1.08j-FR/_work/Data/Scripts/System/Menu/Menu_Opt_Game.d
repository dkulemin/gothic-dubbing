...
INSTANCE MENUITEM_GAME_SUB_TITLES(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Sous-titres";
	text[1]		= 	"Dialogues visuels."; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Fenêtres animées";
	text[1]		= 	"Fenêtres de dialogue animées."; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Inverser la vue";
	text[1]		= 	"Inverser le control camera."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_M(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Souris";
	text[1]		= 	"Activer le control souris."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GAME_BLOOD(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Sang";
	text[1]		= 	"Représentation des effets de sang."; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_GAME_BLOOD_CHOICE(C_MENU_ITEM_DEF)
{
	backPic		=	MENU_CHOICE_BACK_PIC;
	type		=	MENU_ITEM_CHOICEBOX;	
	text[0]		= 	"aucun|un peu|un peu plus|beaucoup";
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
