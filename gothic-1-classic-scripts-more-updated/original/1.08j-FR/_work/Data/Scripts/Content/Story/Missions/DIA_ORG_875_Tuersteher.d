...
INSTANCE DIA_Org_875_PERM (C_INFO)
{
	...
	permanent	= 1;
	description = "Tu laisses seulement entrer les brigands et les gratteurs ?";
};                       
...
{	
	AI_Output (other, self,"DIA_Org_875_PERM_15_00"); //Tu laisses seulement entrer les brigands et les gratteurs ?
	AI_Output (self, other,"DIA_Org_875_PERM_13_01"); //Nous ne nous occupons pas des frères de la secte non plus.
	AI_Output (self, other,"DIA_Org_875_PERM_13_02"); //Mais à part ça, personne n'entre ici.
};
