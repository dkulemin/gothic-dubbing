...
func VOID CH_Level_Info()
{
	...
	Info_AddChoice		(CH_Level, "RETOUR"			 , CH_Level_BACK);
...
func VOID CH_Guild_Info()
{
	...
	Info_AddChoice		(CH_Guild, "RETOUR"			 , CH_Guild_BACK);
...
func void CH_Training_Mana_Info()
{
	...
	Info_AddChoice		(CH_Training_Mana, "RETOUR"	     					, CH_Training_Mana_BACK);
...
func void CH_Training_Combat_Info()
{
	...
	Info_AddChoice		(CH_Training_Combat, "RETOUR"	     				, CH_Training_Combat_BACK);
...
func void CH_Training_Magic_Info()
{
	...
	Info_AddChoice		(CH_Training_Magic, "RETOUR"	     					, CH_Training_Magic_BACK);
...
func void CH_Training_Thievery_Info()
{
	...
	Info_AddChoice		(CH_Training_Thievery, "RETOUR"	     						, CH_Training_Thievery_BACK);
