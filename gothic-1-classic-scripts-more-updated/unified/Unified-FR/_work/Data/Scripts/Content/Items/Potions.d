...
INSTANCE ItFo_Potion_Mana_01(C_Item)
{
	...
	description			= "Essence d'Énergie magique";
...
INSTANCE ItFo_Potion_Mana_02(C_Item)
{
	...
	description			= "Extrait d'Énergie magique";
...
INSTANCE ItFo_Potion_Mana_03(C_Item)
{
	...
	description			= "Élixir d'Énergie magique";
...
INSTANCE ItFo_Potion_Elixier_Egg(C_Item)
{
	...
	description			= "Potion de Chenille";
	TEXT[0]				= "Permet le contact avec le Dormeur.";
...
INSTANCE ItFo_Potion_Dex_01(C_Item)
{
	...
	description			= "Essence de Dextérité";
...
INSTANCE ItFo_Potion_Dex_02(C_Item)
{
	...
	description			= "Extrait de Dextérité";
...
INSTANCE ItFo_Potion_Dex_03(C_Item)
{
	...
	description			= "Élixir de Dextérité";
...
INSTANCE ItFo_Potion_Master_02(C_Item)
{
	...
	description			= "Potion de Suprématie";
...
INSTANCE ItFo_Potion_Haste_01(C_Item)
{
	...
	description		= "Potion de Rapidité";
	TEXT[1]			= "Permet au joueur de faire un court sprint.";
...
INSTANCE ItFo_Potion_Haste_02(C_Item)
{
	...
	description		= "Potion de Vélocité";
	TEXT[1]			= "Permet au joueur de sprinter.";
...
INSTANCE ItFo_Potion_Haste_03(C_Item)
{
	...
	description		= "Potion de Hâte";
	TEXT[1]			= "Permet au joueur de sprinter longuement.";
