...
{
	name 					=	"Armure Lourde du Baron du Minerai";
...
{
	name 					=	"Armure Légère de Mercenaire";
...
{
	name 					=	"Armure Lourde de Mercenaire";
...
{
	name 					=	"Armure Légère de Disciple";
...
{
	name 					=	"Armure Légère de Templier";
...
{
	name 					=	"Armure Lourde de Templier";
...
{
	name 					=	"Armure de Plaque de Chenille";
...
{
	name 					=	"Ancienne Armure de Minerai";
	...
	description				=	name;
	TEXT[0]					=	"Cette ancienne armure a été façonnée avec du minerai magique.";
	TEXT[1]					=	NAME_Prot_Edge;			COUNT[1]	= protection	[PROT_EDGE];
	TEXT[2]					=	NAME_Prot_Point;		COUNT[2]	= protection	[PROT_POINT];
	TEXT[3] 				=	NAME_Prot_Fire;			COUNT[3]	= protection	[PROT_FIRE];
	TEXT[4]					=	NAME_Prot_Magic;		COUNT[4]	= protection	[PROT_MAGIC];
...
{
	name 					=	"Armure de Minerai Améliorée";
	...
	description				=	name;
	TEXT[0]					=	"Pierre, le forgeron, peut même l'améliorer !";
	TEXT[1]					=	NAME_Prot_Edge;			COUNT[1]	= protection	[PROT_EDGE];
	TEXT[2]					=	NAME_Prot_Point;		COUNT[2]	= protection	[PROT_POINT];
	TEXT[3] 				=	NAME_Prot_Fire;			COUNT[3]	= protection	[PROT_FIRE];
	TEXT[4]					=	NAME_Prot_Magic;		COUNT[4]	= protection	[PROT_MAGIC];
