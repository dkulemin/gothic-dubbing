...
instance MENUITEM_MAIN_NEWGAME(C_MENU_ITEM_DEF) 
{
	...
	text[0]		= "Nouvelle Partie";
	text[1]		= "Commencer une nouvelle aventure.";  // Kommentar
...
INSTANCE MENUITEM_MAIN_SAVEGAME_LOAD(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Charger une partie sauvegardée.";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Sauvegarder Partie";
	text[1]		= "Sauvegarder la partie en cours.";  // Kommentar
...
INSTANCE MENUITEM_MAIN_RESUME(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Continuer";
	text[1]		=   "Continuer la partie en cours.";  // Kommentar
...
instance MENUITEM_MAIN_OPTIONS(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Paramètres";
	text[1]		= "Ajuster le jeu, les graphismes, le son et le clavier";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Jouer l'Intro";
	text[1]		= "Jouer la séquence d'intro à nouveau.";
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Quitter Gothic";
	text[1]		= "Quitter le monde de Gothic.";  // Kommentar
