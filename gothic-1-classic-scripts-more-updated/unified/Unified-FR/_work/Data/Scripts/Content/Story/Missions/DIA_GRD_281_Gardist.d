...
{
	AI_Output (other, self,"DIA_Grd_281_GuardGate_15_00"); //Comment va ?
	AI_Output (self, other,"DIA_Grd_281_GuardGate_07_01"); //Bien. Aucun bandits du Nouveau Camp n'a été vu nulle part !
	AI_StopProcessInfos	( self );
};
