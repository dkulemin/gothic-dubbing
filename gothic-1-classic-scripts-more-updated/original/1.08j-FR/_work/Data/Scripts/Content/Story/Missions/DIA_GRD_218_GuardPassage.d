...
FUNC VOID DIA_Grd_218_FirstIn_Info()
{
	...
	AI_Output (self, other,"DIA_Grd_218_FirstIn_07_04"); //Je le ferais. Si tu ment, tu es sûr de mourir !
	AI_Output (other, self,"DIA_Grd_218_FirstIn_15_05"); //Es-tu en train de me dire que je peux pas entrer ?
	AI_Output (self, other,"DIA_Grd_218_FirstIn_07_06"); //C'est ça, bouge!
	AI_StopProcessInfos	(self);
};
...
func void Info_Grd_218_FirstWarn_Info()
{
	...
	AI_Output (self, hero,"Info_Grd_218_FirstWarn_Info_07_03"); //La maison des Barons du minerai n'est pas à la portée d'un déchet comme toi !
