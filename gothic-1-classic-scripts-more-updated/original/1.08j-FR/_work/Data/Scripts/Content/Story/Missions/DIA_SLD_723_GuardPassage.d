...
func void Info_SLD_723_FirstWarn_Info()
{
	...
	AI_Output 		(self, hero,"Info_SLD_723_FirstWarn_11_01"); //ARRÊTE ! Personne ne passe sans le mot de passe !
	...
	if (Npc_KnowsInfo(hero, Info_Cronos_SLEEPER))
	{
		...
		Info_Addchoice 		(Info_SLD_723_FirstWarn,"Cronos m'a donné la permission !",	Info_SLD_723_Parole_CRONOS);  
		Info_Addchoice 		(Info_SLD_723_FirstWarn,"Aucune idée, j'ai oublié.",	Info_SLD_723_Parole_FORGOT);  
...
{
	AI_Output 			(hero, self,"Info_SLD_723_Parole_CRONOS_15_01"); //Cronos m'a donné la permission !
	AI_Output 			(self, hero,"Info_SLD_723_Parole_CRONOS_11_02"); //Si c'est comme ça, il a dû t'avoir donné le mot de passe. Fous le camp, menteur !
	AI_StopProcessInfos	(self);
};

func void Info_SLD_723_Parole_FORGOT ()
{
	AI_Output 			(hero, self,"Info_SLD_723_Parole_FORGOT_15_01"); //Aucune idée, j'ai oublié.
	AI_Output 			(self, hero,"Info_SLD_723_Parole_FORGOT_11_02"); //Ou reviens dès que tu t'en souviendras et ne me fait pas perdre ton temps !
	AI_StopProcessInfos	(self);
};
...
func int Info_SLD_723_PAROLE_Info()
{
	...
	Info_AddChoice 		(Info_SLD_723_PAROLE,"Cronos m'a donné la permission !",	Info_SLD_723_Parole_CRONOS);  
	Info_AddChoice 		(Info_SLD_723_PAROLE,"Aucune idée, j'ai oublié.",	Info_SLD_723_Parole_FORGOT);  
