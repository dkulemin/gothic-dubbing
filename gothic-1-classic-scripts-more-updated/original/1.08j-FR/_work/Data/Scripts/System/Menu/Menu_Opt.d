...
INSTANCE MENUITEM_OPT_GAME(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Jeu";
	text[1]		= "Éditer plusieurs paramètres du jeu.";  // Kommentar
...
INSTANCE MENUITEM_OPT_GRAPHICS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Graphisme";
	text[1]		= "Distance Visuelle, détails et effets.";  // Kommentar
...
instance MENUITEM_OPT_VIDEO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		=	"Vidéo";
	text[1]		=	"Carte Vidéo, résolution et luminosité.";  // Kommentar
...
INSTANCE MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Son";
	text[1]		= "Musique, voix et effets sonores.";  // Kommentar
...
INSTANCE MENUITEM_OPT_CONTROLS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Clavier";
	text[1]		= "Configuration du clavier.";  // Kommentar
...
INSTANCE MENUITEM_PERF(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Optimiser la performance et la qualité.";  // Kommentar
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "paramètre personnalisé#haute performance|qualité moyenne|haute qualité";	// # trennt die UnDef-Option von der auswaehlbaren Optionen
