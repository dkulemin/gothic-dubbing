...
FUNC VOID B_Kapitelwechsel (VAR INT neues_Kapitel)
{
	...
	if		(neues_Kapitel == 1)
	{
		...
		IntroduceChapter ("Chapitre 1","Bienvenue à la Colonie","chapter1.tga","levelup.wav", 6000);
	}
	...
	else if	(neues_Kapitel == 2)
	{
		...
		IntroduceChapter ("Chapitre 2","Le Nid des Chenilles des Mines","chapter2.tga","levelup.wav", 6000);
	}
	...
	else if (neues_Kapitel == 3)
	{
		...
		IntroduceChapter ("Chapitre 3","Les Reliques du Pouvoir Ancien","chapter3.tga","levelup.wav", 6000);
	}
	...
	else if (neues_Kapitel == 4)
	{
		...
		B_LogEntry			(CH4_Firemages,"Saturas, le chef des Magiciens de l'Eau, m'a demandé une dernière faveur. Pour faire exploser l'amas de minerai il demande l'aide des Magiciens du Feu dans le Vieux Camp. Je ne sais pas comment persuader les magiciens de Gomez de prendre part au plan qui détruira les fondations de leur pouvoir, mais je trouverai.");
		...
		IntroduceChapter ("Chapitre 4","Xardas","chapter4.tga","levelup.wav", 6000); 
	}
	...
	else if (neues_Kapitel == 5)
	{
		...
		//-------- Tagebucheinträge --------
		B_LogEntry		(CH4_EnterTemple,	"Gorn n'a pas été très confiant dans cet Ulu-Mulu qui est censé m'aider dans la ville Orc... Et alors ? Je verrai bien de toute façon.");

		//-------- Oberwelt-Monster nochmal "nachfüllen" --------	
		B_Story_RespawnOW();
		
		//IntroduceChapter ("Kapitel 5","Die Hüter des Portals","chapter5.tga","levelup.wav", 6000);
		IntroduceChapter ("Chapitre 5","Les Gardiens du Portail","chapter5.tga","levelup.wav", 6000);
	}
	...
	else if (neues_Kapitel == 6)
	{
		...
		IntroduceChapter ("Chapitre 6","Le Temple du Dormeur","chapter6.tga","levelup.wav", 6000);
	};
};
