	...
	instance Schutzring_Feuer1(C_Item)
{
	...
	description		= "Anneau de peau de Hêtre";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Geschosse1(C_Item)
{
	...
	description		= "Anneau de peau de bois";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Geschosse2(C_Item)
{
	...
	description		= "Anneau de peau de pierre";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Point;
	...
	INSTANCE Schutzring_Waffen1(C_Item)
{
	...
	description		= "Anneau de peau de fer";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Waffen2(C_Item)
{
	...
	description		= "Anneau de peau de chêne";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Magie1(C_ITEM)
{
	...
	description		= "Anneau de Puissance Spirituelle";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Magie1_Fire1(C_ITEM)
{
	...
	description		= "Anneau de Purification";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Magic;
	...
	INSTANCE Schutzring_Geschosse1_Waffen1(C_ITEM)
{
	...
	description		= "Anneau d'Immuabilité";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Geschosse2_Waffen2(C_ITEM)
{
	...
	description		= "Anneau d'Accusation";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Total1(C_ITEM)
{
	...
	description		= "Anneau de moindre Invincibilité";
	//TEXT[0]			= "";
	...
	INSTANCE Schutzring_Total2(C_ITEM)
{
	...
	description		= "Anneau de grande Invincibilité";
	//TEXT[0]			= "";
	TEXT[1]			= NAME_Prot_Magic;
	COUNT[1]		= 3;
	TEXT[2]			= NAME_Prot_Fire;
		...
		INSTANCE Ring_des_Geschicks(C_Item)
{
	...
	description		= "Anneau de moindre Dextérité";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Ring_des_Geschicks2(C_Item)
{
	...
	description		= "Anneau de grande Dextérité";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
	...
	INSTANCE Ring_des_Lebens2(C_Item)
{
	...
	description		= "Anneau de grande Vie";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_HP;
		...
		INSTANCE Ring_der_Erleuchtung(C_Item)
{
	...
	description		= "Anneau d'Illumination";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Mana;
	...
	INSTANCE Machtring(C_Item)
{
	...
	description		= "Anneau de Pouvoir du Guerrier";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Str;
