...
func void rtn_fmtaking_244()
{
	TA_FollowPC(7,0,20,0,"FM_3");
	TA_FollowPC(20,0,7,0,"FM_3");
};

func void rtn_tofmtaken_244()
{
	TA_Stay(7,0,20,0,"FM_WAR");
	TA_Stay(20,0,7,0,"FM_WAR");
};

func void rtn_endfmtaken_244()
{
	TA_Guard(7,0,20,0,"FM_3");
	TA_Guard(20,0,7,0,"FM_3");
};
