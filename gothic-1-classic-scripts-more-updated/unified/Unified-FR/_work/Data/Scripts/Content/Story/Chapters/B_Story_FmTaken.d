...
func void B_Story_FMTaken()
{
	...
	{
		B_LogEntry	(CH4_Firemages,"Diego a été capable de m'en dire plus sur les évènements dans le Vieux Camp.");
	}
	else
	{
		B_LogEntry	(CH4_Firemages,"A l'arrière du Vieux Camp, Diego m'a intercepté et m'a averti de sérieux incidents qui viennent de se produire.");
	};
	B_LogEntry		(CH4_Firemages,"après l'effondrement de la Vieille Mine, Gomez a ordonné à ses hommes d'attaquer la mine Libre du Nouveau Camp. Quand Corristo et ses Magiciens du Feu se sont opposés au plan, ils ont été tué par les hommes de Gomez.");
	B_LogEntry		(CH4_Firemages,"Je dois avertir le Nouveau Camp aussi vite que je peux et informer Saturas de l'incident. J'espère qu'il n'est pas trop tard.");
