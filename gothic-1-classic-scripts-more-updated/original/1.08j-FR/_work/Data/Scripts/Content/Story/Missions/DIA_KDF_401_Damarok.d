...
func void  KDF_401_Damarok_WELCOME_Info()
{
	...
	AI_Output (self, other,"KDF_401_Damarok_WELCOME_Info_14_01"); //Puisse le Feu  te protéger éternellement!
...
{
	AI_Output (self, other,"KDF_401_Damarok_HEAL_Info_14_01"); //Si tu es blessé, je te guérirai.
	AI_StopProcessInfos	( self );
};
// ***************************** INFOS ****************************************//
...
{
	AI_Output (other, self,"KDF_401_Damarok_HEALINFO_Info_15_01"); //Je suis blessé. Pouvez-vous me guérir ?
	AI_Output (self, other,"KDF_401_Damarok_HEALINFO_Info_14_02"); //Le corps guérit, l'esprit s'éclaircit.
