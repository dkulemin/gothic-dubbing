...
INSTANCE MENUITEM_VID_DEVICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Carte Video";
	text[1]		=	"Gothic doit redémarrer pour cette option !"; // Kommentar
...
INSTANCE MENUITEM_VID_RESOLUTION(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Résolution";
	text[1]		= "Confirmer résolution en pressant ENTRER."; // Kommentar
