...
instance EBR_106_Bartholo(Npc_Default)
{
	...
	CreateInvItems(self,ItFoSoup,32);
	CreateInvItems(self,ItFoWine,5);
	CreateInvItems(self,ItFo_Plants_mountainmoos_02,7);
	CreateInvItems(self,ItFoApple,22);
	CreateInvItems(self,ItFo_wineberrys_01,18);
