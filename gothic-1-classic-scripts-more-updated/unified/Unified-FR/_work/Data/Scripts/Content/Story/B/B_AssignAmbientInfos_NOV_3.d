...
{
	AI_Output(other,self,"Info_Nov_3_EinerVonEuchWerden_15_00"); //Comment puis-je rejoindre ce camp ?
	AI_Output(self,other,"Info_Nov_3_EinerVonEuchWerden_03_01"); //C'est simple. Laisse toi aller, mec.
	AI_Output(self,other,"Info_Nov_3_EinerVonEuchWerden_03_02"); //Parle aux Sages, ils te guideront !
};
...
{
	AI_Output(other,self,"Info_Nov_3_WichtigePersonen_15_00"); //Qui est le patron par ici ?
	AI_Output(self,other,"Info_Nov_3_WichtigePersonen_03_01"); //Y'Bérion ! Le Dormeur soit loué ! Il nous a amené à ce glorieux endroit.
	AI_Output(self,other,"Info_Nov_3_WichtigePersonen_03_02"); //Tout ceci a été crée au travers de ses visions.
};
...
INSTANCE Info_Nov_3_DasLager(C_INFO)
{
	...
	permanent	= 1;
	description = "Y a t'il un endroit important ici où je devrais aller ?";
};                       
...
{
	AI_Output(other,self,"Info_Nov_3_DasLager_15_00"); //Y a t'il un endroit important ici où je devrais aller ?
	AI_Output(self,other,"Info_Nov_3_DasLager_03_01"); //Il y a Fortuno. Il donne de l'Herbe gratuitement à tous les adeptes de la secte.
	AI_Output(self,other,"Info_Nov_3_DasLager_03_02"); //Tu le trouvera en-dessous du laboratoire d'alchimie de Cor Kalom.
...
{
	AI_Output(other,self,"Info_Nov_3_DieLage_15_00"); //Comment vas-tu ?
	AI_Output(self,other,"Info_Nov_3_DieLage_03_01"); //Je me sens trés bien, mec !
};
