...
func void rtn_fmtaking_229()
{
	TA_FollowPC(7,0,20,0,"FM_5");
	TA_FollowPC(20,0,7,0,"FM_5");
};

func void rtn_tofmtaken_229()
{
	TA_Stay(7,0,20,0,"FM_WAR");
	TA_Stay(20,0,7,0,"FM_WAR");
};

func void rtn_endfmtaken_229()
{
	TA_Guard(7,0,20,0,"FM_5");
	TA_Guard(20,0,7,0,"FM_5");
};
