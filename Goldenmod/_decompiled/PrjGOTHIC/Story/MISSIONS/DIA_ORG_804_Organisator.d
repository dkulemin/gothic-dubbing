...
func void Org_804_Organisator_WayTo_Info()
{
	...
	AI_Output(self,other,"Org_804_Organisator_WayTo_06_01");	//К Ларесу.
...
instance Org_804_Organisator_ToLares(C_Info)
{
	...
	permanent = 0;
	description = "Я хочу встретиться с Ларесом.";
};
...
{
	AI_Output(other,self,"Org_804_Organisator_ToLares_15_00");	//Я хочу увидеть Лареса.
...
instance Org_804_Organisator_PERM(C_Info)
{
	...
	permanent = 1;
	description = "Могу я увидеть Лареса?";
};
...
{
	AI_Output(other,self,"Org_804_Organisator_PERM_15_00");	//Могу я увидеть Лареса?
