...
{
	AI_Output (other, self,"DIA_Butch_Hello_15_00"); //Hé. Qui es-tu ?
	AI_Output (self, other,"DIA_Butch_Hello_13_01"); //Ce n'est pas tes affaires ! Je n'aime pas ta tête !
	AI_StopProcessInfos	( self );
};
