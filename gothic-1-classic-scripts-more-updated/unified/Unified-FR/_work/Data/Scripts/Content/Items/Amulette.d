...
INSTANCE ItMi_Amulet_Psi_01(C_Item)
{
	...
	description		= "Signe de la Confrérie";
	//TEXT[0]			= "";
	//TEXT[2]			= "";
	////COUNT[2]		= ;
	//TEXT[3] 		= "";
...
INSTANCE  Schutzamulett_Feuer(C_Item)
{
	...
	description		= "Amulette de Flammes";
	//TEXT[0]			= "";
	...
	INSTANCE  Schutzamulett_Geschosse(C_ITEM)
{
	...
	description		= "Amulette de Peau de Chêne";
	//TEXT[0]			= "";
	...
	INSTANCE  Schutzamulett_Magie(C_ITEM)
{
	...
	description		= "Amulette de Pouvoir Spirituel";
	//TEXT[0]			= "";
	...
	INSTANCE  Schutzamulett_Magie_Feuer(C_ITEM)
{
	...
	description		= "Amulette fr Purification";
	//TEXT[0]			= "";
	TEXT[2]			= NAME_Prot_Fire;
	COUNT[2]		= 10;
		...
		INSTANCE  Schutzamulett_Waffen_Geschosse(C_ITEM)
{
	...
	description		= "Amulette de Peau de Pierre";
	//TEXT[0]			= "";
	TEXT[2]			= NAME_Prot_Edge;
	COUNT[2]		= 15;
	...
	INSTANCE  Schutzamulett_Total(C_ITEM)
{
	...
	description		= "Amulette de Peau de Minerai";
	//TEXT[0]			= "";
	...
	INSTANCE  Gewandtheitsamulett(C_Item)
{
	...
	description		= "Amulette d'Agilité";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE  Gewandtheitsamulett2(C_Item)
{
	...
	description		= "Amulette de Dextérité";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
	...
	INSTANCE  Staerkeamulett(C_Item)
{
	...
	description		= "Amulette de Pouvoir";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE  Lebensamulett(C_Item)
{
	...
	description		= "Amulette de Force de Vie";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE  Amulett_der_Macht(C_Item)
{
	...
	description		= "Amulette de Puissance";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
...
{
	name 			=	"Amulette d'Éclaircissement";
	...
	description		= "Amulette d'Éclaircissement";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_HP;
