	...
	{	
		if (typ.lp >= LP_cost)
		{
			...
			{	
				...
				PrintScreen	("Apprendre: Combattre avec des armes à une mains", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_2H)
			{
				...
				PrintScreen	("Apprendre: Combattre avec des armes à deux mains", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_BOW)
			{
				...
				PrintScreen	("Apprendre: Tirer avec un arc", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_CROSSBOW)
			{
				...
				PrintScreen	("Apprendre: Tirer avec une arbalète", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_PICKLOCK)
			{
				...
				PrintScreen	("Apprendre: Crocheter les serrures", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
