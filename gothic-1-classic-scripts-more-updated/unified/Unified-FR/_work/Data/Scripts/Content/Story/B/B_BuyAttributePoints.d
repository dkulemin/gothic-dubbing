func void B_BuyAttributePoints (var C_NPC typ, var int ATR, var int AtrPlus)
{
	...
	if (!(typ.lp < AtrPlus))
	{
		...
		{
			PrintScreen	("Ne peut pas dépasser un maximum de 100 !", -1,-1,"FONT_OLD_20_WHITE.TGA",1);
			B_Say (self, other, "$NOLEARNOVERMAX");
		};
	}
	else 
	{
		PrintScreen	("Pas assez de points de compétence !", -1,-1,"FONT_OLD_20_WHITE.TGA",1);
