...
instance  GRD_261_Brandick_ALEPH (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description		= "(se plaindre de Aleph)"; 
};
...
{
	AI_Output			(other, self,"GRD_261_Brandick_ALEPH_Info_15_01"); //Écoute, quand tu es absent Aleph reste assis tout le temps et ne fait rien !
	AI_Output			(self, other,"GRD_261_Brandick_ALEPH_Info_06_02"); //C'est vrai?
	AI_Output			(self, other,"GRD_261_Brandick_ALEPH_Info_06_03"); //Tu sais ce que je méprise encore plus que les faineants? Les traîtres. Alors fous le camp !
