...
const string MOBNAME_OLDCHEST = "Старый сундук";
...
const string TXT_SPELLS[59] =
{
	...
	"Портал к Некроманту",
	"Портал к оркам",
	"Портал в Болотный Лагерь",
	"Трансформация в шершня",
	"нет",
	"Трансформация в ползуна",
	"Трансформация в шныгу",
	"Трансформация в мясного жука",
	"Трансформация в кротокрыса",
	"Трансформация в орочью гончую",
	"нет",
	"Трансформация в падальщика",
	"n/a",
	"Трансформация в мракориса",
	"Трансформация в глорха",
	"Трансформация в ящерицу",
	"Трансформация в волка",
	"Молния",
	"Ледяная стрела",
	"Шаровая молния",
	"Ледяная глыба",
...
{
	"",
	"не обучен|боец|мастер",
	"не обучен|боец|мастер",
	"не обучен|стрелок|мастер",
	"не обучен|стрелок|мастер",
...
const string NAME_Learn2h_2 = "Двуручный меч, уровень 2";
...
const string PRINT_POTIONMADE = "Эликсир готов";
