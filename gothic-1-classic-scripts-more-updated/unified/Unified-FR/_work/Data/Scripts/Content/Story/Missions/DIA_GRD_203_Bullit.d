...
{
	AI_Output (self, other,"DIA_Bullit_First_06_00"); //Qui avons-nous ici ? Ce n'est pas toi le gars que j'ai baptisé plus tôt ? Que veux-tu ? Tu reviens pour autre chose ?
};
...
instance  DIA_Bullit_AufsMAul (C_INFO)
{
	...
	permanent	= 0;
	description = "Je suis venu pour fermer ta grande gueule.";
};                       
...
{
	AI_Output (other, self,"DIA_Bullit_AufsMAul_15_00"); //Je suis venu pour fermer ta grande gueule.
	AI_Output (self, other,"DIA_Bullit_AufsMAul_06_01"); //Et bien,  viens ici et fait un essai, fiston !
...
{
	AI_Output (self, other,"DIA_GRD_203_Bullit_Wait4SC_06_01"); //Encore toi? ! J'aurai dû te noyer dans le lac le jour ou je t'ai vu!
	AI_Output (other, self,"DIA_GRD_203_Bullit_Wait4SC_15_02"); //Je n'ai pas eu de chance jusqu'ici - maintenant les rôles sont inversés.
	AI_Output (self, other,"DIA_GRD_203_Bullit_Wait4SC_06_03"); //Espèce de vermisseau ! J'espère que tu ne le feras pas aussi facilement pour moi que tu ne l'as fait la première fois !
