...
{
	AI_Output(other,self,"Info_Bau_4_WichtigePersonen_15_00"); //Avez-vous un chef ?
	AI_Output(self,other,"Info_Bau_4_WichtigePersonen_04_01"); //tu peux dire que le Seigneur du Riz est notre chef. Mais la plupart d'entre nous travaille pour lui de peur qu'il n'envoie ces hommes.
	AI_Output(self,other,"Info_Bau_4_WichtigePersonen_04_02"); //Pas comme moi. Je suis ici depuis plusieurs années et j'en ai assez d'être frappé par les bandits du Camp... Le champ de riz est bien pour moi.
...
{
	AI_Output(other,self,"Info_Bau_4_DasLager_15_00"); //Il y a quelque chose que je devrais savoir sur cet endroit ?
	AI_Output(self,other,"Info_Bau_4_DasLager_04_01"); //Fait attention au Camp, mon garçon ! Il y a beaucoup de coupe-gorge, attendant juste de mettre la main sur un nouveau venu comme toi.
};
...
{
	AI_Output(other,self,"Info_Bau_4_DieLage_15_00"); //Comment va ?
	AI_Output(self,other,"Info_Bau_4_DieLage_04_01"); //Il y a beaucoup de travaille. Nous avons besoin de beaucoup de riz pour tous ces gens.
};
...
{
	AI_Output(other,self,"Info_Bau_4_Wasser_15_00"); //Lefty m'envoie. Je t'apporte de l'eau.
	if (Npc_HasItems(other, ItFo_Potion_Water_01)>=1)
	{
		...
		AI_Output(self,other,"Info_Bau_4_Wasser_04_01"); //Merci, mon garçon ! J'en avais besoin !
	...
	{
		AI_Output(self,other,"Info_Bau_4_Wasser_NOWATER_04_00"); //Mais tu n'en a plus. Hé bien, laisse tomber, mon garçon. Je demanderais aux autres.
	};
};
