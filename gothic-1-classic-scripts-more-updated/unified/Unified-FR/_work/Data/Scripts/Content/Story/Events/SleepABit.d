...
func void PC_Sleep (var int t)
{
	...
	PrintScreen	("Vous avez bien dormi et vous vous sentez mieux", -1,-1,"font_old_20_white.tga",3);
...
INSTANCE PC_SleepTime_Morning (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Dormir jusqu'au matin"; 
};
...
INSTANCE PC_SleepTime_Noon (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Dormir jusqu'à midi"; 
};
...
INSTANCE PC_SleepTime_Evening (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Dormir jusqu'au soir"; 
};
...
instance PC_SleepTime_Midnight (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Dormir jusqu'à minuit"; 
};
