...
{
	AI_Output(other,self,"Org_825_Organisator_PERM_15_00");	//Что вы охраняете?
	AI_Output(self,other,"Org_825_Organisator_PERM_07_01");	//Мы следим за тем, чтобы никто из людей Ли и Гомеза не приближался к Ларесу.
	AI_StopProcessInfos(self);
};
