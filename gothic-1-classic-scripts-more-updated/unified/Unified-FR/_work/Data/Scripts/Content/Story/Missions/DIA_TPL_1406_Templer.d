...
instance  DIA_KalomsGuard_PERM (C_INFO)
{
	...
	permanent	= 1;
	description	= "Je suis sûr que tu ne t'attendais pas à mon arrivée ici... ?";
};                       
...
{
	AI_Output (other, self,"DIA_KalomsGuard_PERM_15_00"); //Je suis sûr que tu ne t'occuperais pas de moi ici... ?
	AI_Output (self, other,"DIA_KalomsGuard_PERM_13_01"); //Si tu manques de respect à mon maître, je te tuerai.
	AI_StopProcessInfos	( self );
};
