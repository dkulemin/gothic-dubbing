...
{
	AI_AskText( self, NOFUNC, NOFUNC, "Oui", "Non" );
...
{
	AI_AskText( self, NOFUNC, NOFUNC, "Ouais", "Nop" );
...
FUNC VOID Info_Test_Procedure_Choice()
{
	...
	Info_AddChoice		( Info_Test_Choice, "Oui"		, Info_Test_Procedure_Choice_Yes 	);
	Info_AddChoice		( Info_Test_Choice, "Non"		, Info_Test_Procedure_Choice_No 	);
	Info_AddChoice		( Info_Test_Choice, "Sais pas", Info_Test_Procedure_Choice_Unsure );	
	Info_AddChoice		( Info_Test_Choice, "Quitter"		, Info_Test_Procedure_Choice_Exit	);	
};
...
FUNC VOID Info_Test_Procedure_Permanent_Choice()
{
	...
	Info_AddChoice		( Info_Test_Permanent_Choice, "D'accord"			, Info_Test_Procedure_Permanent_Choice_Yes 		);
	Info_AddChoice		( Info_Test_Permanent_Choice, "Va te faire foutre"	, Info_Test_Procedure_Permanent_Choice_No 		);
	Info_AddChoice		( Info_Test_Permanent_Choice, "Hmm..."		, Info_Test_Procedure_Permanent_Choice_Unsure 	);	
	Info_AddChoice		( Info_Test_Permanent_Choice, "(quitter)"		, Info_Test_Procedure_Permanent_Choice_Exit		);	
};
...
FUNC VOID Info_Test_Procedure_Permanent_Important_Choice()
{
	...
	Info_AddChoice		( Info_Test_Permanent_Important_Choice, "Oui"			, Info_Test_Procedure_Permanent_Important_Choice_Yes 		);
	Info_AddChoice		( Info_Test_Permanent_Important_Choice, "Non"			, Info_Test_Procedure_Permanent_Important_Choice_No 		);
	Info_AddChoice		( Info_Test_Permanent_Important_Choice, "Sais pas"	, Info_Test_Procedure_Permanent_Important_Choice_Unsure 	);	
	Info_AddChoice		( Info_Test_Permanent_Important_Choice, "Adieu"			, Info_Test_Procedure_Permanent_Important_Choice_Exit		);	
};
