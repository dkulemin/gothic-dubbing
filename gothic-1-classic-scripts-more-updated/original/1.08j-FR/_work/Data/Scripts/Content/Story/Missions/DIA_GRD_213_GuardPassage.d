...
func void Info_Grd_213_FirstWarn_Info()
{
	...
	AI_Output (self, hero,"Info_Grd_213_FirstWarn_Info_07_03"); //Tu n'as pas le droit d'entrer dans le château ! Rossez-le !
...
{
	AI_Output (other, self,"Info_Grd_213_Abblitzen_15_00"); //Tu sais, tu devrais vraiment mettre un peu plus de piment dans ta vie. Comme par exemple laisser quelqu'un dans le château.
	AI_Output (self, other,"Info_Grd_213_Abblitzen_07_01"); //Du piment ? Ce n'est pas une mauvaise idée - ça fait longtemps que je n'ai pas rossé quelqu'un comme toi.
	AI_StopProcessInfos	(self);
};
...
{
	AI_Output (other, self,"Info_Grd_213_Passgate_15_00"); //Hé, ca va ?
	AI_Output (self, other,"Info_Grd_213_Passgate_07_01"); //Ne traîne pas ici - entre!
	AI_StopProcessInfos	(self);
};
