...
func void rtn_fmtaking_232()
{
	TA_FollowPC(7,0,20,0,"FM_4");
	TA_FollowPC(20,0,7,0,"FM_4");
};

func void rtn_tofmtaken_232()
{
	TA_Stay(7,0,20,0,"FM_WAR");
	TA_Stay(20,0,7,0,"FM_WAR");
};

func void rtn_endfmtaken_232()
{
	TA_Guard(7,0,20,0,"FM_4");
	TA_Guard(20,0,7,0,"FM_4");
};
