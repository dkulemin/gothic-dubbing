...
instance DIA_DEXTER_QUENTIN(C_Info)
{
	...
	permanent = 0;
	description = "Ты можешь что-нибудь сказать о доставке товаров в шахту?";
};
...
{
	AI_Output(other,self,"DIA_Dexter_Quentin_15_00");	//Ты можешь что-нибудь сказать о доставке товаров в шахту?
	AI_Output(self,other,"DIA_Dexter_Quentin_10_01");	//Ты что, работаешь на этих болотных придурков?
};
