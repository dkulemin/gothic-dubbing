...
INSTANCE MENUITEM_GRA_TEXQUAL(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Détail Texture ";
	text[1]		= 	"Niveau Détail textures."; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Modèle Détail";
	text[1]		= 	"Niveau Détail des objets."; // Kommentar
	// Position und Dimension	
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Champs visuel";
	text[1]		= "Champs visuel en pourcentage."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Changer effets du ciel on/off"; // Kommentar
	// Position und Dimension	
