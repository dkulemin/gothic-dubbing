...
func void Info_TPL_1442_FirstWarn_Info()
{
	...
	AI_Output		(self, hero,"Info_TPL_1442_FirstWarn_13_01"); //ARRÊTE ! tu peux entrer dans la colline du temple seulement si tu as l'autorisation d'un Sage !
	...
	if (Npc_KnowsInfo(hero, PC_Psionic_SEND))
	{
		...
		Info_Addchoice 		(Info_TPL_1442_FirstWarn,"Y'Bérion lui-même m'a donné la permission.",	Info_TPL_1442_FirstWarn_Condition_YBERION);  
		Info_Addchoice 		(Info_TPL_1442_FirstWarn,"Le novice Lester m'a envoyé.",	Info_TPL_1442_FirstWarn_Condition_LESTER);  
	}
	else
	{
...
{
	AI_Output (hero, self,"Info_TPL_1442_FirstWarn_Condition_YBERION_15_01"); //Y'Bérion lui-même m'a donné la permission.
	AI_Output (self, hero,"Info_TPL_1442_FirstWarn_Condition_YBERION_13_02"); //Les menteurs ont tendance à perdre leurs langues facilement, alors tu ferais mieux de me dire ce que tu sais.
};

func void Info_TPL_1442_FirstWarn_Condition_LESTER ()
{
	AI_Output (hero, self,"Info_TPL_1442_FirstWarn_Condition_LESTER_15_01"); //Je suis envoyé par le novice Lester. J'offre mes services à Y'Bérion.
	AI_Output (self, hero,"Info_TPL_1442_FirstWarn_Condition_LESTER_13_02"); //Lester est digne de confiance. Je le connais. tu peux passer.
	Info_Clearchoices 	(Info_TPL_1442_FirstWarn);
...
{
	AI_Output 		(self, hero,"Info_TPL_1442_LastWarn_13_01"); 		//Un pas de plus et tu es mort.
