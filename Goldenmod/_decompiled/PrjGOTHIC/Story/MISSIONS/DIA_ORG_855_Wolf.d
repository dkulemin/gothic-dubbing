...
func void DIA_Wolf_SellArmor_Info()
{
	...
	if((Npc_GetTrueGuild(other) == GIL_ORG) || (Npc_GetTrueGuild(other) == GIL_SLD) || (Npc_GetTrueGuild(other) == GIL_KDW))
	{
	...
	{
		AI_Output(self,other,"DIA_Wolf_SellArmor_WRONGGUILD_09_00");	//Прости, парень, я не могу ничего тебе продать. Ларес убьет меня, если узнает, что я продал доспехи чужаку.
	};
};
...
func void ORG_855_Wolf_TRAIN_Info()
{
	...
	{
		AI_Output(self,other,"ORG_855_Wolf_TRAIN_Info_09_04");	//У тебя недостаточно руды.
	};
};
...
func void ORG_855_Wolf_TRAINAGAIN_Info()
{
	...
	{
		AI_Output(self,other,"ORG_855_Wolf_TRAINAGAIN_Info_09_06");	//Сначала принеси мне руду, парень.
	};
};
