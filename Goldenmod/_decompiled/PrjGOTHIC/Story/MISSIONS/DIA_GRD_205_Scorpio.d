...
{
	if(((Kapitel >= 4) || (Npc_GetTrueGuild(hero) == GIL_GRD)) && (Npc_GetTalentSkill(hero,NPC_TALENT_CROSSBOW) != 1))
	{
		return TRUE;
	};
};
...
{
	if((Npc_GetTalentSkill(hero,NPC_TALENT_CROSSBOW) == 1) && (Npc_GetTalentSkill(hero,NPC_TALENT_CROSSBOW) != 2))
	{
		return TRUE;
	};
};
