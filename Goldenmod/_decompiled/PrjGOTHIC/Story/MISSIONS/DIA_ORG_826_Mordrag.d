...
instance Org_826_Mordrag_JoinNewcamp(C_Info)
{
	...
	permanent = 0;
	description = "А если я захочу присоединиться к Новому Лагерю...";
};
...
func void Org_826_Mordrag_JoinNewcamp_Info()
{
	...
	AI_Output(self,other,"Org_826_Mordrag_JoinNewcamp_11_01");	//Если ты это серьезно, мы можем отправиться туда прямо сейчас. Я отведу тебя к Ларесу - он у нас за главного.
...
func void Org_826_Mordrag_AtNewcamp_Info()
{
	...
	AI_Output(self,other,"Org_826_Mordrag_AtNewcamp_11_01");	//За этими воротами находится Новый Лагерь. Поговори с Ларесом - он поможет тебе. Отдашь ему это кольцо.
	AI_Output(self,other,"Org_826_Mordrag_AtNewcamp_11_02");	//Понадобится серьезный довод, чтобы Ларес принял тебя. Эта дорогая безделушка будет для тебя пропуском.
	...
	B_LogEntry(CH1_JoinNC,"Вот мы и стоим перед воротами Нового Лагеря. Мордраг дал мне кольцо, которое я должен передать Ларесу, лидеру воров, если решу присоединиться к этому Лагерю. Сам же Мордраг останется в баре.");
...
instance Org_826_Mordrag_GotoKalom(C_Info)
{
	...
	permanent = 0;
	description = "У меня послание от Лареса.";
};
...
{
	AI_Output(other,self,"Org_826_Mordrag_GotoKalom_15_00");	//У меня послание от Лареса.
	AI_Output(self,other,"Org_826_Mordrag_GotoKalom_11_01");	//Говори.
	AI_Output(other,self,"Org_826_Mordrag_GotoKalom_15_02");	//Ларес хочет знать, что происходит в Лагере Сектантов. Он поручил это задание тебе.
	AI_Output(self,other,"Org_826_Mordrag_GotoKalom_11_03");	//Мне кажется, все это как-то разрешится само собой...
	B_LogEntry(CH1_JoinNC,"Я передал Мордрагу слова Лареса. Он что-то пробормотал в ответ. Что-то о том, что все само собой улаживается. Понятия не имею, о чем это он!");
};
...
instance Org_826_Mordrag_GotoKalomNOW(C_Info)
{
	...
	permanent = 0;
	description = "Ларес велел мне помочь тебе в деле сектантов.";
};
...
{
	AI_Output(other,self,"Org_826_Mordrag_GotoKalomNOW_15_00");	//Ларес велел мне помочь тебе в деле сектантов.
