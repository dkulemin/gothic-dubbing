...
FUNC VOID  DIA_GorNaRan_Wache_Info()
{
	...
	AI_Output (self, other,"DIA_GorNaRan_Wache_13_01"); //Je m'assure que les requins des marais ne s'approchent pas trop près du camp.
	AI_Output (self, other,"DIA_GorNaRan_Wache_13_02"); //Si j'étais toi, j'éviterais ces bêtes. Tu n'as aucune chance contre elles.
	AI_Output (self, other,"DIA_GorNaRan_Wache_13_03"); //Maintenant ne me dérange plus, je dois ouvrir l'œil.
	AI_StopProcessInfos	( self );
};
...
{
	AI_Output (self, other,"Info_TPL_1405_GorNaRan_Info_13_01"); //Où penses-tu que je vais ? Personne n'a le droit de passer ici !
};
...
FUNC VOID Info_TPL_1405_GorNaRan2_Info()
{
	...
	AI_Output (self, other,"Info_TPL_1405_GorNaRan_Info_13_03"); //Tu me demandes ce qui se passe ici ? Prosterne-toi dans la poussière et rend hommage au Dormeur, parce qu'en ce moment précis il se réveille pour bannir tous les infidèles de ce monde.
};
...
{	
	...
	AI_Output (self, other,"Info_TPL_1405_GorNaRan_Info_13_05"); //Sale vermisseau, toi et les gens de ta sorte n'ont plus rien à faire ici quand le Dormeur se réveille ! Je vais te mettre à l'écart.
...
INSTANCE Info_TPL_1405_GorNaRan4 (C_INFO)
{
	...
	permanent	= 0;
	description = "Tu ne peux pas m'arrêter !";
};                       
...
{	
	AI_Output (other, self,"Info_TPL_1405_GorNaRan_Info_15_06"); //Tu ne peux pas m'arrêter !
	AI_Output (self, other,"Info_TPL_1405_GorNaRan_Info_13_07"); //Quelque soit ce que tu dis, mon garçon, pour le Dormeur !
