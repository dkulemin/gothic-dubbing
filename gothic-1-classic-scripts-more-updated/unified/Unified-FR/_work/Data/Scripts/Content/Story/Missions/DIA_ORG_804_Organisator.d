...
{
	AI_Output (self, other,"Org_804_Organisator_Greet_06_00"); //Maintenant où vas-tu ?
};
...
{
	AI_Output (other, self,"Org_804_Organisator_WayTo_15_00"); //Où PUIS-JE aller ?
	AI_Output (self, other,"Org_804_Organisator_WayTo_06_01"); //Voir Lares.
...
instance  Org_804_Organisator_ToLares (C_INFO)
{
	...
	permanent	= 0;
	description  = "Je veux voir Lares.";
};                       
...
{
	AI_Output (other, self,"Org_804_Organisator_ToLares_15_00"); //Je veux voir Lares.
	AI_Output (self, other,"Org_804_Organisator_ToLares_06_01"); //Je doute qu'il te parle.
	AI_Output (other, self,"Org_804_Organisator_ToLares_15_02"); //Laisse-moi faire.
	AI_Output (self, other,"Org_804_Organisator_ToLares_06_03"); //Je ne t'arrêterais pas.
	AI_StopProcessInfos	(self);
};
...
instance  Org_804_Organisator_PERM (C_INFO)
{
	...
	permanent	= 1;
	description  = "Puis-je voir Lares ?";
};                       
...
{
	AI_Output (other, self,"Org_804_Organisator_PERM_15_00"); //Puis-je voir Lares ?
	AI_Output (self, other,"Org_804_Organisator_PERM_06_01"); //Règle ça avec Roscoe.
	AI_StopProcessInfos	(self);
};
...
func void Info_Org_804_FirstWarn_Info()
{
	...
	AI_Output (self, hero,"Info_Org_804_FirstWarn_Info_06_00"); //Les serviteurs de Gomez n'entrent pas ici ! Dégage !
...
{
	AI_Output (self, hero,"Info_Org_804_LastWarn_06_00"); //Vas-y tant que tu peux encore marcher !
