...
instance INFO_BALORO_EXIT(C_Info)
{
	npc = SLD_753_Baloro;
	nr = 999;
	condition = info_baloro_exit_condition;
	information = info_baloro_exit_info;
	permanent = 1;
	description = DIALOG_ENDE;
};


func int info_baloro_exit_condition()
{
	if(BALOROOK == TRUE)
	{
		return 1;
...
func void info_baloro_exit_info()
{
...
func void DIA_SLD_753_Baloro_Worumgehts_Info()
{
	...
	AI_Output(other,self,"DIA_SLD_753_Baloro_Worumgehts_Info_15_02");	//Как насчет хорошего меча, тяжелых доспехов и допуска в шахту?
