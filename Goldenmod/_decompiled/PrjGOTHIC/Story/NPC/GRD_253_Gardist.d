...
func void rtn_fmtaking_253()
{
	TA_FollowPC(7,0,20,0,"FM_1");
	TA_FollowPC(20,0,7,0,"FM_1");
};

func void rtn_tofmtaken_253()
{
	TA_Stay(7,0,20,0,"FM_WAR");
	TA_Stay(20,0,7,0,"FM_WAR");
};

func void rtn_endfmtaken_253()
{
	TA_Guard(7,0,20,0,"FM_1");
	TA_Guard(20,0,7,0,"FM_1");
};
