...
func void rtn_fmtaking_252()
{
	TA_FollowPC(7,0,20,0,"FM_2");
	TA_FollowPC(20,0,7,0,"FM_2");
};

func void rtn_tofmtaken_252()
{
	TA_Stay(7,0,20,0,"FM_WAR");
	TA_Stay(20,0,7,0,"FM_WAR");
};

func void rtn_endfmtaken_252()
{
	TA_Guard(7,0,20,0,"FM_2");
	TA_Guard(20,0,7,0,"FM_2");
};
