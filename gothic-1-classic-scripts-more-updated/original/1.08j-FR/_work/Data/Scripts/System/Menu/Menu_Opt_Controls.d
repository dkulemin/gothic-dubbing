...
{
	text[0]			=	"Avant ";
	text[1]			=   "Presser RETOUR ARRIERE pour effacer et ENTRER pour redéfinir."; // Kommentar
...
INSTANCE MENU_ITEM_INP_UP(C_MENU_ITEM_DEF)
{
	...
	text[1] 	=   "Presser la touche désirée.";
...
{
	text[0]		=	"Paramètre par défaut";	
	text[1]		=	"Remet le clavier par défaut."; // Kommentar
...
{
	text[0]		=	"Clavier alternatif";	
	text[1]		=	"Activer un paramètre clavier alternatif."; // Kommentar
